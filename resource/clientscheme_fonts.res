Scheme
{
	...
	Fonts
	{
		...
		"G_FontHuge"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Primary font
				"name"			"Dosis" [!$WINDOWS] // Primary font
		...
		"G_FontHuge_2"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Secondary font
				"name"			"Dosis" [!$WINDOWS] // Secondary font
		...
		"G_FontHealth"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Health Font | Primary font
				"name"			"Dosis" [!$WINDOWS] // Health Font | Primary font
		...
		"G_FontAmmo"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Ammo Font | Primary font
				"name"			"Dosis" [!$WINDOWS] // Ammo Font | Primary font
		...
		"G_FontDamage"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Damage font | Primary font
				"name"			"Dosis" [!$WINDOWS] // Damage font | Primary font
				"tall"			"20" // Damage size
				"weight"		"0"
				"additive"		"0"
		...
		"G_FontCritDamage"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Crit damage font | Primary font
				"name"			"Dosis" [!$WINDOWS] // Crit damage font | Primary font
		...
		"G_FontTargetIDHealth"
		{
			"1"
			{
				"name"			"Dosis" [$WINDOWS] // Target ID health font | Primary font
				"name"			"Dosis" [!$WINDOWS] // Target ID health font | Primary font
		...
		"CloseCaption_Normal"
		{
			"1"
			{
				"name"		"Dosis" [$WINDOWS] // Closed captions font | Secondary font
				"name"		"Dosis" [!$WINDOWS] // Closed captions font | Secondary font
	...
	CustomFontFiles
	{
		...
		"4" 
		{
			"font" "resource/DosisSecondary.ttf"
			"name" "Dosis Secondary"
			"russian"
			{
				"range" "0x0000 0xFFFF"
		...
		"5" 
		{
			"font" "resource/DosisProfessor.ttf"
			"name" "Dosis Professor"
			"russian"
			{
				"range" "0x0000 0x00FF"
